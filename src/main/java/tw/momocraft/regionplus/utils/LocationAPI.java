...
public class LocationAPI {
    ...
    public static boolean getBlocks(Location loc, String path) {
        ...
        if (blocksConfig != null) {
            Set<String> blockConfig = blocksConfig.getKeys(false);
            for (String block : blockConfig) {
                if (block.equals("Range")) {
    ...
    private static boolean getXYZ(Location loc, String key, String keyValue) {
        if (keyValue != null) {
            ...
            int keyArray0 = Integer.parseInt(keyArray[0]);
            int keyArray1 = Integer.parseInt(keyArray[1]);
            int keyArray2 = Integer.parseInt(keyArray[2]);
            if (xyzLength == 1) {
                if (key.equalsIgnoreCase("X")) {
                    return getRange(loc.getBlockX(), keyArray0);
                } else if (key.equalsIgnoreCase("Y")) {
                    return getRange(loc.getBlockY(), keyArray0);
                } else if (key.equalsIgnoreCase("Z")) {
                    return getRange(loc.getBlockZ(), keyArray0);
                    ...
                    return getRange(loc.getBlockX(), keyArray0) &&
                            getRange(loc.getBlockY(), keyArray0) &&
                            getRange(loc.getBlockZ(), keyArray0);
                } else if (key.equalsIgnoreCase("!XYZ")) {
                    return !getRange(loc.getBlockX(), keyArray0) &&
                            !getRange(loc.getBlockY(), keyArray0) &&
                            !getRange(loc.getBlockZ(), keyArray0);
                    ...
                    return getRadius(loc, keyArray0);
                } else if (key.equalsIgnoreCase("!R")) {
                    return !getRadius(loc, keyArray0);
                }
            } else if (xyzLength == 2) {
                if (key.equalsIgnoreCase("X")) {
                    return getCompare(loc.getBlockX(), keyArray[0], keyArray1);
                } else if (key.equalsIgnoreCase("Y")) {
                    return getCompare(loc.getBlockY(), keyArray[0], keyArray1);
                } else if (key.equalsIgnoreCase("Z")) {
                    return getCompare(loc.getBlockZ(), keyArray[0], keyArray1);
                } else if (key.equalsIgnoreCase("!X")) {
                    return !getCompare(loc.getBlockX(), keyArray[0], keyArray1);
                } else if (key.equalsIgnoreCase("!Y")) {
                    return !getCompare(loc.getBlockY(), keyArray[0], keyArray1);
                    ...
                    return getCompare(loc.getBlockX(), keyArray[0], keyArray1) &&
                            getCompare(loc.getBlockY(), keyArray[0], keyArray1) &&
                            getCompare(loc.getBlockZ(), keyArray[0], keyArray1);
                } else if (key.equalsIgnoreCase("!XYZ")) {
                    return !getCompare(loc.getBlockX(), keyArray[0], keyArray1) &&
                            !getCompare(loc.getBlockY(), keyArray[0], keyArray1) &&
                            !getCompare(loc.getBlockZ(), keyArray[0], keyArray1);
                ...
                if (key.equalsIgnoreCase("X")) {
                    return getRange(loc.getBlockX(), keyArray0, keyArray2);
                } else if (key.equalsIgnoreCase("Y")) {
                    return getRange(loc.getBlockY(), keyArray0, keyArray2);
                } else if (key.equalsIgnoreCase("Z")) {
                    return getRange(loc.getBlockZ(), keyArray0, keyArray2);
                } else if (key.equalsIgnoreCase("!X")) {
                    return !getRange(loc.getBlockX(), keyArray0, keyArray2);
                } else if (key.equalsIgnoreCase("!Y")) {
                    return !getRange(loc.getBlockY(), keyArray0, keyArray2);
                    ...
                    return getRange(loc.getBlockX(), keyArray0, keyArray2) &&
                            getRange(loc.getBlockY(), keyArray0, keyArray2) &&
                            getRange(loc.getBlockZ(), keyArray0, keyArray2);
                } else if (key.equalsIgnoreCase("!XYZ")) {
                    return !getRange(loc.getBlockX(), keyArray0, keyArray2) &&
                            !getRange(loc.getBlockY(), keyArray0, keyArray2) &&
                            !getRange(loc.getBlockZ(), keyArray0, keyArray2);
                    ...
                    return getRadius(loc, keyArray0, keyArray1, keyArray2);
                } else if (key.equalsIgnoreCase("!R")) {
                    return !getRadius(loc, keyArray0, keyArray1, keyArray2);
                }
            } else if (xyzLength == 4) {
                if (key.equalsIgnoreCase("R")) {
                    return getRadius(loc, keyArray0, keyArray1, keyArray2, Integer.valueOf(keyArray[3]));
                } else if (key.equalsIgnoreCase("!R")) {
                    return !getRadius(loc, keyArray0, keyArray1, keyArray2, Integer.valueOf(keyArray[3]));
                }
            }
