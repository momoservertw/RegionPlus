    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        switch (args.length) {
            case 1:
                ...
                if (CorePlusAPI.getPlayerManager().hasPerm(sender, "regionplus.command.residence.reset") ||
                        CorePlusAPI.getPlayerManager().hasPerm(sender, "regionplus.command.returnignorey")) {
            ...
            case 2:
                if (CorePlusAPI.getPlayerManager().hasPerm(sender, "regionplus.command.residence.reset")) {
                ...
                } else if (CorePlusAPI.getPlayerManager().hasPerm(sender, "regionplus.command.residence.returnignorey")) {
                    ...
                    if (CorePlusAPI.getPlayerManager().hasPerm(sender, "regionplus.command.points.other")) {
                        try {
                            ...
                            CorePlusAPI.getLangManager().sendDebugTrace(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), e);
                        }
                    }
                }
        }
