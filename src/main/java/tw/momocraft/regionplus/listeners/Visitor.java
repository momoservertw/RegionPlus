...
public class Visitor implements Listener {
    ...
    public void onVisitorItemsConsume(PlayerItemConsumeEvent e) {
        ...
        if (ConfigHandler.getConfigPath().isVisItemConsume()) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Consume", "return", "Allow",
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Consume", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        ...
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Consume", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisItemJoin()) {
            if (CorePlusAPI.getUtilsManager().isCustomItem(player.getInventory().getItemInMainHand())) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Consume", "bypass", "ItemJoin",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onVisitorItemsBucket(PlayerBucketFillEvent e) {
        ...
        if (ConfigHandler.getConfigPath().isVisItemBucket()) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Bucket", "return", "Allow",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        Location loc = player.getLocation();
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Bucket", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Bucket", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisItemJoin()) {
            if (CorePlusAPI.getUtilsManager().isCustomItem(player.getInventory().getItemInMainHand())) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Bucket", "bypass", "ItemJoin",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onVisitorItemsFishing(PlayerFishEvent e) {
        ...
        if (ConfigHandler.getConfigPath().isVisItemFishing()) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Fishing", "return", "Allow",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        Location loc = player.getLocation();
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Fishing", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Fishing", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisItemJoin()) {
            if (CorePlusAPI.getUtilsManager().isCustomItem(player.getInventory().getItemInMainHand())) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Fishing", "bypass", "ItemJoin",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onVisitorItemsProjectile(ProjectileLaunchEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Projectile", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Projectile", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisItemJoin()) {
            if (CorePlusAPI.getUtilsManager().isCustomItem(player.getInventory().getItemInMainHand())) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Use-Item: Projectile", "bypass", "ItemJoin",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onVisitorInteractEntities(PlayerInteractEntityEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Entity", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Entity", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisInterEntNPC()) {
            if (entity.hasMetadata("NPC")) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Entity: NPC", "bypass",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onPlayerInteract(PlayerInteractEvent e) {
        ...
        if (action.equals(Action.PHYSICAL)) {
            ...
            // Bypass Permission
            if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Block", "bypass", "Permission",
                        new Throwable().getStackTrace()[0]);
                return;
            }
            // Allow Residence Bypass
            if (ConfigHandler.getConfigPath().isVisResBypass()) {
                if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                    CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Block", "bypass", "Residence Bypass",
                            new Throwable().getStackTrace()[0]);
                    return;
                }
            }
            ...
            if (ConfigHandler.getConfigPath().isVisInterBlockUse()) {
                if (CorePlusAPI.getUtilsManager().isCanUse(blockType)) {
                    CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Block: Use", "return",
                            new Throwable().getStackTrace()[0]);
                    return;
                }
            }
        ...
        if (action.equals(Action.LEFT_CLICK_BLOCK) || action.equals(Action.RIGHT_CLICK_BLOCK)) {
            ...
            if (ConfigHandler.getConfigPath().isVisInterBlockCont()) {
                if (CorePlusAPI.getUtilsManager().isContainer(blockType)) {
                    CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Interact-Block: Container", "return",
                            new Throwable().getStackTrace()[0]);
                    return;
                }
            }
    ...
    public void onVisitorDropItems(PlayerDropItemEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Drop-Item", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Drop-Item", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
    ...
    public void onVisitorPickupItems(EntityPickupItemEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Pickup-Item", "bypass", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Pickup-Item", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
    ...
    public void onVisitorDamageEntities(EntityDamageByEntityEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Damage-Entity", "return", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Damage-Entity", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
        ...
        if (ConfigHandler.getConfigPath().isVisDamageEntPlayer()) {
            if (entity instanceof Player) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Damage-Entity: Player", "bypass", entity.getName(),
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
    ...
    public void onPlayerDeathEvent(PlayerDeathEvent e) {
        ...
        // Bypass Permission
        if (CorePlusAPI.getPlayerManager().hasPerm(player, "regionplus.bypass.visitor")) {
            CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Death-Drop", "return", "Permission",
                    new Throwable().getStackTrace()[0]);
            return;
        }
        // Allow Residence Bypass
        if (ConfigHandler.getConfigPath().isVisResBypass()) {
            if (CorePlusAPI.getConditionManager().isInResidence(loc)) {
                CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPluginPrefix(), "Visitor", playerName, "Death-Drop", "bypass", "Residence Bypass",
                        new Throwable().getStackTrace()[0]);
                return;
            }
        }
